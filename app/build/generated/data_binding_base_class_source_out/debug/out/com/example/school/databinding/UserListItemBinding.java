...
public final class UserListItemBinding implements ViewBinding {
  ...
  private UserListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView userEmail,
  ...
  public static UserListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserListItemBinding((LinearLayout) rootView, userEmail, userName);
    }
